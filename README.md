...
![Gráfica de Exactitud vs Orden](imagenes/exactitud_vs_orden.png)
...
![Modelos espectrales de las vocales](imagenes/modelos_vocales_orden_8.png)
...
![Exactitud vs Filtros](imagenes/mfcc_exactitud_vs_nfilt.png)
...
![Curva de Aprendizaje del Modelo](imagenes/grafica_curva_aprendizaje.png)
...
![Comparativa de Modelos](imagenes/grafica_comparativa_modelos.png)
...
![Matriz de Confusión Final](imagenes/grafica_matriz_confusion.png)
